...
<!--
세문 중 상품이 있는 문을 처음에 고를 경우의 수는 1, 선택을 바꾼다면 무조건 꽝을 고르게 되고 선택을 바꾸고 실패할 경우의 수는 1, 선택을 바꾸지 않는다면 무조건 상품을 고르게 되고 선택을 바꾸지 않고 성공할 경우의 수는 1.
상품이 없는, 꽝인 문을 처음에 고를 경우의 수는 2, 사회자가 남은 꽝인 문을 무조건 열어줄 것이고, 바꾼다면 무조건 상품을 고르게 되므로 선택을 바꾸고 성공할 경우의 수는 2, 선택을 바꾸지 않는다면 꽝을 고르게 되므로 선택을 바꾸지 않고 실패할 경우의 수는 2이다.

즉 선택을 변경하지 않았을때 성공할 경우의 수는 1가지, 실패할 경우의 수는 2가지이다.
반면 선택을 변경했을 경우 성공할 경우의 수는 2가지, 실패할 경우의 수는 1가지이다.

선택을 바꾸었을때 성공할 경우의 수가 선택을 바꾸지 않았을때의 경우의 수보다 더 많기 때문에, 선택을 바꾸는 것이 더 높은 확률로 상품을 고르게 된다.
-->
# 경우의 수 세어보기
